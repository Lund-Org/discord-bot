...
export class SyncSchemas1615576830941 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("ALTER TABLE `player_inventory` ADD `type` varchar(255) NOT NULL")
        await queryRunner.query("ALTER TABLE `pagination` ADD `discordUser_id` varchar(255) NOT NULL")
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `pagination` DROP COLUMN `discordUser_id`")
        await queryRunner.query("ALTER TABLE `player_inventory` DROP COLUMN `type`")
    }
}
