...
export class UpdateDatabaseTables1625929118327 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      'CREATE TABLE `birthday` (`id` int NOT NULL AUTO_INCREMENT, `discord_id` varchar(255) NOT NULL, `birthday_day` int NOT NULL, `birthday_month` int NOT NULL, `birthday_year` int NOT NULL, UNIQUE INDEX `IDX_3b052876e3445fb67185f04c43` (`discord_id`), PRIMARY KEY (`id`)) ENGINE=InnoDB',
    );
    await queryRunner.query(
      'ALTER TABLE `player` CHANGE `twitch_username` `twitch_username` varchar(255) NULL DEFAULT NULL',
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'ALTER TABLE `player` CHANGE `twitch_username` `twitch_username` varchar(255) NULL',
    );
    await queryRunner.query(
      'DROP INDEX `IDX_3b052876e3445fb67185f04c43` ON `birthday`',
    );
