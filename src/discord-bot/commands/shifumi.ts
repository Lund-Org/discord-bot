  ...
  return new SlashCommandBuilder()
    ...
    .addStringOption(option =>
      option.setName('action')
        ...
        .setRequired(true)
        .addChoice('Pierre', ShifumiEnum.PIERRE)
        .addChoice('Feuille', ShifumiEnum.FEUILLE)
        .addChoice('Ciseaux', ShifumiEnum.CISEAUX)
    )
    .toJSON();
}
...
function shifumiCallback(interaction: CommandInteraction) {
  ...
  if (
    ...
    return interaction.reply(`J'ai choisi "${botChoice}".... J'ai donc gagné ! 🎉`)
